		...
		<tbody style="<?php echo $reset; ?>">
										...
										<tbody style="<?php echo $reset; ?>">
											...
											<?php foreach( $posts as $post ) : ?>
												<?php if( !empty( $post->post_excerpt ) ) : ?>
													...
													<?php elseif( $count == count( $posts ) && get_option( $prefix . 'subscribe_banner' ) == '' ) : ?>
			...
			<tr style="<?php echo $reset; ?>">
				<td style="width:600px; <?php echo $reset; ?>">
					...
					<p style="line-height: 19px; text-align:center; margin:0 0 30px 0; padding:0;">View in <a href="<?php echo $web_url; ?>" style="color:#<?php echo $color['text_secondary']; ?>; <?php echo $reset; ?>">Web Browser</a> | <a href="<?php echo $unsubscribe_url; ?>" style="color:#<?php echo $color['text_secondary']; ?>; <?php echo $reset; ?>">Unsubscribe</a></p>
				</td>
			</tr>
