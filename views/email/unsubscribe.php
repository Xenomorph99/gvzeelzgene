		...
		<tbody style="<?php echo $reset; ?>">
			...
			<tr style="<?php echo $reset; ?>">
				<td style="width:600px; <?php echo $reset; ?>">
					<p style="line-height:19px; text-align:center; margin:8px 0 16px 0; padding:0;">View in <a href="<?php echo $web_url; ?>" style="color:#bcbec0; <?php echo $reset; ?>">Web Browser</a></p>
				</td>
			</tr>
				...
				<td style="width:600px; <?php echo $reset; ?>">
					...
					<table style="color:#58595b; background-color:#ffffff; border-collapse:collapse; width:600px; margin:0 auto; padding:0; line-height:0; border:none;" cellpadding="0" cellspacing="0">
						...
						<?php endif; ?>
							...
							<?php if( !empty( get_option( $prefix . 'unsubscribe_banner' ) ) ) : ?>
								...
								<td style="<?php echo $reset; ?>">
									<table style="border-collapse:collapse; width: 560px; border:none; margin:0 auto; padding:0; line-height:0;" cellpadding="0" cellspacing="0">
										<tbody style="<?php echo $reset; ?>">
											...
											<?php if( $count == count( $posts ) && empty( get_option( $prefix . 'unsubscribe_banner' ) ) ) : ?>
			...
			<tr style="<?php echo $reset; ?>">
				<td style="width:600px; <?php echo $reset; ?>">
					...
					<p style="line-height: 19px; text-align:center; margin:0 0 30px 0; padding:0;">View in <a href="<?php echo $web_url; ?>" style="color:#bcbec0; <?php echo $reset; ?>">Web Browser</a></p>
				</td>
			</tr>
